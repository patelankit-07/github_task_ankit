...
class FilterProductsCategory extends StatefulWidget {
  String name;

  FilterProductsCategory({super.key, required this.name});

  @override
  State<FilterProductsCategory> createState() => _FilterProductsCategoryState();
}

class _FilterProductsCategoryState extends State<FilterProductsCategory> {
  @override
  Widget build(BuildContext context) {
    return MainLayout(
      appBar: customAppBar(context: context, title:  Text(widget.name,style: TextStyle(color: white),),centerTitle:true ),
      body: Padding(
            ...
            builder: (context, provider, child) {
              ...
              return Padding(
                ...
                child: GridView.builder(
                  ...
                  itemCount: provider.filteredProductsByCategory.length,
                  itemBuilder: (context, index) {
                    final product = provider.filteredProductsByCategory[index];
